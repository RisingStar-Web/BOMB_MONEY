 ...
 * the owner.
 */
contract OwnableUpgradeable, Initializable, is Initializable, ContextUpgradeSafe {
...
contract RegulationStats is OwnableUpgradeable, Initializable,IRegulationStats {
    ...
    function initialize(address _treasury) external initializer {
        OwnableUpgradeable, Initializable,.__Ownable_init();
